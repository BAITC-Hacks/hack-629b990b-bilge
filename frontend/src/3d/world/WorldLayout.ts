...
const PRESET_DISTRICTS: Record<BuildingPreset, District[]> = {
  cafe: ['business', 'green', 'innovation'], shop: ['business', 'innovation', 'green'],
  warehouse: ['innovation', 'business', 'green'], lab: ['innovation', 'business', 'green'],
  academy: ['green', 'innovation', 'business'], clinic: ['green', 'business', 'innovation'],
...
export function placeTasks(tasks: TaskLike[]): TaskPlacement[] {
  ...
  for (const t of rest) {
    ...
    const prefs = PRESET_DISTRICTS[presetFor(t.industry)];
