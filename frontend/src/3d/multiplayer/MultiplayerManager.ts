...
import type { Emote, MovementState, PlayerPresence, PlayerTick } from '../../shared/types';
...
export class MultiplayerManager {
  ...
  private join = () => {
    ...
    this.socket.emit('world.player.join', { p: [m.x, 0, m.z], r: m.r }, (res: { you?: string; players?: PlayerPresence[]; netHz?: number; error?: string }) => {
