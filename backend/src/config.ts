...
const schema = z.object({
  ...
  AI_TIMEOUT_MS: z.coerce.number().int().min(100).max(30000).default(30000),
  AI_MAX_OUTPUT_TOKENS: z.coerce.number().int().min(1024).max(8192).default(4096),
  GIT_MODE: z.enum(['real', 'mock']).default('real'),
  GITHUB_TOKEN: z.string().optional(),
  GIT_TIMEOUT_MS: z.coerce.number().int().min(100).max(30000).default(15000),
